...
const I18N = {
  en: {
    ...
    'hero.tagline': 'I build end-to-end solutions with Node.js, NestJS and TypeScript, and integrate artificial intelligence (RAG, multi-agent systems, LLMs) to solve real-world problems.',
    ...
    'ai.c2.title': 'Multi-agent system with streaming',
    'ai.c2.body': 'Multi-agent analysis system with a supervisor agent and quality control at every stage, delivering real-time responses via Server-Sent Events (SSE).',
    ...
    'exp.job1.b3': 'AI service (in progress): <strong>RAG</strong> over pgvector with a user-curated knowledge base, and a <strong>multi-agent system</strong> (4 specialized agents + a supervisor agent, with quality control over both the prompt and the response) that generates personalized session analyses (text and Mermaid diagrams) grounded in a user-selected theoretical framework.',
    ...
    'cred.dt.desc': '90 days as a Fullstack Developer. Web, mobile and AI service (RAG · pgvector, SSE, OAuth).',
